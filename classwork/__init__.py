...
def create_app(config, debug=False, testing=False, config_overrides=None):
    ...
    app.register_blueprint(crud, url_prefix='/classwork')
    from .mathSym.crud import mathsym as mathSymCrud 
    app.register_blueprint(mathSymCrud, url_prefix='/mathsym')
...
def login_required_auth(f):
    ...
    def decorated_function(*args, **kwargs):
        loginUrl='http://mail.mbc.edu.mo/internal/login'
        if session=={}:
